...
interface RegisterProps { setIsLoggedIn: Function; setIsBusiness: Function; }

const Register: FunctionComponent<RegisterProps> = ({ setIsLoggedIn, setIsBusiness }) => {
  ...
  return (
    <div className="container mt-3 col-md-4 text-center">
      <h3 className="display-4">REGISTER BIZ</h3>
